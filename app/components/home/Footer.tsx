    ...
    <footer className="py-12 px-6 border-t border-white/5 bg-black/60">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 bg-amber-500 rounded flex items-center justify-center font-bold text-white text-xs">
            A
          </div>
      ...
      <div className="max-w-7xl mx-auto mt-8 text-center text-gray-600 text-xs">
        © 2026 ArchitectAI Inc. All rights reserved.
      </div>
    </footer>
  );
};
