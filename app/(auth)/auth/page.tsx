...
interface AuthPageProps {
  setView: (view: "landing" | "studio" | "auth") => void;
}
...
const AuthPage: React.FC<AuthPageProps> = ({ setView }) => {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] mt-6 flex items-center justify-center p-6 relative overflow-hidden grid-bg">
      ...
      <div className="absolute top-1/4 right-1/4 w-150 h-150 bg-cyan-600/10 rounded-full blur-[100px] -z-10"></div>
        ...
        <div className="glass p-8 md:p-10 rounded-3xl border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#0b0f1a] px-4 text-gray-500 font-bold tracking-widest">
                Or email
              </span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1 ml-1">
                Optional — only needed for new accounts
              </p>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-4 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-bold text-sm shadow-lg shadow-indigo-600/20 transition-all transform hover:scale-[1.02] active:scale-[0.98] mt-4 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
